...
# Inter-service auth for the Obsidian vault service (Compose env or hosted
# OBSIDIAN_VAULT_TOKEN_FILE; never apps.keys — Obsidian Sync provider secrets
# live there separately).
